...
#define I_SERIAL_RX_PIN                    Z2_SERIAL_TX_PIN
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {   8.66,   8.66 }
    #define DEFAULT_Ki_LIST {   0.42,   0.42 }
    #define DEFAULT_Kd_LIST {  44.32,  44.32 }
  #else
    #define DEFAULT_Kp  22.21
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 495, 615, 615 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 15, 25, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 500, 5000, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -41, 14.35, 0 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 8.2
#define Y_MAX_POS Y_BED_SIZE + 54.7
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 20, 5, 20, 5 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       2.0        // (mm) Z height of nozzle between tramming points
...
//#define Y_SAFE_HOMING_X_POS X_CENTER

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (8*60), (16*60) }
