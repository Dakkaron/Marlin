...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BIGTREE_SKR_V1_1
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 70, 00, 0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_MIN_POS // ((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT Y_MIN_POS // ((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
#endif
...
// Preheat Constants
#define PREHEAT_1_LABEL       "215.0"
#define PREHEAT_1_TEMP_HOTEND 215
#define PREHEAT_1_TEMP_BED      0
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "215.60"
